/* soapStub.h
   Generated by gSOAP 2.8.60 for ./header/calc.h
...
struct ns2__addResponse;	/* ./header/calc.h:317 */
struct ns2__add;	/* ./header/calc.h:317 */
struct ns2__subResponse;	/* ./header/calc.h:388 */
struct ns2__sub;	/* ./header/calc.h:388 */
struct ns2__mulResponse;	/* ./header/calc.h:459 */
struct ns2__mul;	/* ./header/calc.h:459 */
struct ns2__divResponse;	/* ./header/calc.h:530 */
struct ns2__div;	/* ./header/calc.h:530 */
struct ns2__powResponse;	/* ./header/calc.h:601 */
struct ns2__pow;	/* ./header/calc.h:601 */
